...
class _HomeTabState extends State<_HomeTab> {
  ...
  Future<void> _launchWhatsAppSupport() async {
    final cleanPhone = AppConstants.businessContactPhone
        .replaceAll('+', '')
        .replaceAll(' ', '')
        .trim();
    final formattedPhone = cleanPhone.startsWith('91')
        ...
        : '91$cleanPhone';
    const message =
        "Hello Shantinath Agro Agency, I would like to place an order or make an inquiry.";
    ...
    if (await canLaunchUrl(uri)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Could not launch WhatsApp. Please install it.'),
        ),
      );
    }
  }
  ...
  void _handleBannerClick(PromoBanner banner) {
    if (banner.targetType == 'brand') {
      ...
      final product = context.read<ProductProvider>().getProductById(
        banner.targetValue,
      );
      if (product != null) {
        Navigator.pushNamed(
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // Welcome Greeting
              SliverToBoxAdapter(
                child: _buildWelcomeGreeting(context, isMarathi),
              ),
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Text(
                    isMarathi
                        ? 'कंपनी निवडा आणि खरेदी करा'
                        : 'Select Company to Shop',
                                    ...
                                    ? Image.asset(
                                        ...
                                        errorBuilder:
                                            (context, error, stackTrace) {
                                              return _buildBrandInitialsBadge(
                                                brand,
                                              );
                                            },
                                      )
...
class _ShopTab extends StatelessWidget {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final labelText = category == 'All'
                    ? allLabel
                    : (isMarathi
                          ? (AppConstants.categoriesMr[category] ?? category)
                          : category);
          ...
          builder: (context, provider, _) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isSelected =
                    (crop == 'All' && provider.selectedCropType == null) ||
  ...
  Widget _buildActiveFiltersChipsRow(
    BuildContext context,
    ProductProvider provider,
    bool isMarathi,
  ) {
            ...
            if (provider.selectedCategory != null)
              Padding(
                ...
                child: Chip(
                  label: Text(
                    isMarathi
                        ? (AppConstants.categoriesMr[provider
                                  .selectedCategory] ??
            ...
            if (provider.selectedCropType != null)
              Padding(
                ...
                child: Chip(
                  label: Text(
                    isMarathi
                        ? (AppConstants.cropTypesMr[provider
                                  .selectedCropType] ??
      ...
      builder: (context, provider, _) {
        ...
        return Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                context.watch<LocaleProvider>().isMarathi
                    ? 'उत्पादने'
                    : 'Products',
                style: GoogleFonts.outfit(
                  fontSize: 20,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isMarathi
                      ? 'कृपया तुमचे शोध शब्द किंवा फिल्टर बदला'
...
class _ProductRowItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String displayName = isMarathi && product.nameMr.isNotEmpty
        ? product.nameMr
        : product.name;
  ...
  void _showQuantityDialog(
    ...
    final controller = TextEditingController(
      text: '${cartProvider.getQuantity(product.id)}',
    );
    showDialog(
      context: context,
